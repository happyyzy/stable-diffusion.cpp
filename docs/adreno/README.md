...
| Z-Image 1024 VAE decode-only | decode (s) | 33.53 (ggml decode reference) | 9.25 | 3.62x | `docs/adreno/steps/step20.md` |
| FLUX.2-klein 1024 VAE decode-only (full-decode final) | decode (s) | 32.80 (ggml decode reference) | 5.25 | 6.25x | `exp_20260218_klein_q40/step23_full_decode_mldrift/README.md` |
